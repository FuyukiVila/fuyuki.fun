...
export const siteConfig: SiteConfig = {
    ...
    banner: {
        ...
        credit: {
            ...
            text: "アシマ / Dream Blue", // Credit text to be displayed
...
export const navBarConfig: NavBarConfig = {
    links: [
        ...
        {
            name: "GitHub",
            url: "https://github.com/fuyukivila/fuyuki.fun", // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
    avatar: "assets/images/fuyuki_vila.png", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
    name: "Fuyuki_Vila",
    bio: "Haru La Fuyuki",
    links: [
        {

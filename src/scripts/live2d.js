document.addEventListener('DOMContentLoaded', () => {
    try {
        ...
        $("<link>").attr({ href: path + "@styles/waifu.css", rel: "stylesheet", type: "text/css" }).appendTo('head');
        $('body').append('<div class="waifu"><div class="waifu-tips"></div><canvas id="live2d" class="live2d"></canvas><div class="waifu-tool"><span class="fui-home"></span> <span class="fui-chat"></span> <span class="fui-eye"></span> <span class="fui-user"></span> <span class="fui-photo"></span> <span class="fui-info-circle"></span> <span class="fui-cross"></span></div></div>');
        $.ajax({
            url: path + "assets/waifu-tips.min.js", dataType: "script", cache: true, success: function () {
                $.ajax({
                    url: path + "assets/live2d.min.js", dataType: "script", cache: true, success: function () {
                        /* 可直接修改部分参数 */
...
const waifu_tips =
{
    ...
    "mouseover": [
        {
            ...
            "text": [
                "要看看 <span style=\"color:#0099cc;\">{text}</span> 么？"
            ]
        },
        {
    ...
    "seasons": [
        ...
        },
        {
            "date": "03/08",
            "text": [
                "今天是<span style=\"color:#0099cc;\">妇女节</span>！"
            ]
        },
        {
            "date": "03/12",
            "text": [
                "今天是<span style=\"color:#0099cc;\">植树节</span>，要保护环境呀"
            ]
        },
        {
            "date": "04/01",

...
const waifu_tips = {
    ...
    "mouseover": [
        { "selector": "a.transition[href^='/posts/']", "text": ["要看看 <span style=\"color:#0099cc;\">{text}</span> 么？"] },
        { "selector": "a[href^='/archive/category/']", "text": ["要看看 <span style=\"color:#0099cc;\">{text}</span> 么？"] },
        { "selector": "a[href^='/archive/tag/']", "text": ["要看看 <span style=\"color:#0099cc;\">{text}</span> 么？"] },
        { "selector": "#post-container a[href^='http']", "text": ["要看看 <span style=\"color:#0099cc;\">{text}</span> 么？"] },
        ...
        { "selector": "a[href='/archive/']", "text": ["这里都有些什么呢？"] },
        { "selector": "a[href='/about/']", "text": ["想知道有关本站的信息吗？"] },
        ...
        { "selector": "a[href='https://hikari.fuyuki.fun/']", "text": ["这是另一个站点哦~"]},

        { "selector": "#scheme-switch", "text": ["深夜时要爱护眼睛呀"] },
        { "selector": "#back-to-top-btn", "text": ["biu！直达顶部"] },

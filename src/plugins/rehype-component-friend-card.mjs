		...
		[
			h("div", { class: "flex flex-row p-5 gap-4 items-center w-full" }, [
				h(
					...
					{
						class:
							"flex flex-shrink-0 justify-center items-center w-[75px] h-[75px] rounded-full overflow-hidden border-2 transition-all duration-300",
					},
					[
						h("img", {
							src: avatar,
				...
				h("div", { class: "flex-1 flex flex-col justify-center" }, [
					...
					description
						? h(
								...
								{
									class:
										"text-base font-semibold text-[var(--text-dim)] mb-3 italic",
								},
								description,
							)
						: null,
					h(
						...
						[
							...
							h(
								...
								{
									class:
										"transition-transform duration-200 group-hover:animate-moveRight",
								},
								"→",
							),
						],
